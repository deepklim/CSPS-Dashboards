Attribute VB_Name = "Chart_J_"
Option Explicit

'Hardcoded: End of data source (X132), axis labels, For loops
Sub Chart_J(WS As Worksheet, top_left_corner As Range, title As String)
    ...
    cht.Chart.SetSourceData Source:=WS.Range("X37:X132")
