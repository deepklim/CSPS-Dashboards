...
'Harcoded: Global averages: (1.1 for 2017-18, ? for 2018-19)
Sub Chart_I(WS As Worksheet, top_left_corner As Range, title As String, course_code As String)
    ...
    cht.Chart.SetSourceData Source:=WS.Range("AE22:AF23")
    ...
    cht.Chart.FullSeriesCollection(2).Values = Array(1.1, 1.1)
