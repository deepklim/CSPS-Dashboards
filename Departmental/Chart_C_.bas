Attribute VB_Name = "Chart_C_"
Option Explicit

Sub Chart_C(WS As Worksheet, top_left_corner As Range, x_labels As Variant, y_labels As Variant, title As String)
    ...
    cht.Chart.SetSourceData Source:=WS.Range("W19:X28")
