Attribute VB_Name = "Chart_E_"
Option Explicit

Sub Chart_E(WS As Worksheet, top_left_corner As Range, x_labels As Variant, y_labels As Variant, title As String)
    ...
    cht.Chart.SetSourceData Source:=WS.Range("AB23:AC24")
    cht.Chart.ChartType = xlBarClustered
    cht.Chart.ChartArea.height = 115
    ...
    cht.Chart.Axes(xlValue).MaximumScale = Application.Max(WS.Range("AB24:AC24")) * 1.2
