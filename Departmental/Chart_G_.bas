...
Sub Chart_G(WS As Worksheet, top_left_corner As Range, x_labels As Variant, y_labels As Variant, title As String)
    ...
    cht.Chart.SetSourceData Source:=WS.Range("W34:X43")
