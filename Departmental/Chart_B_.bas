Attribute VB_Name = "Chart_B_"
Option Explicit

Sub Chart_B(WS As Worksheet, top_left_corner As Range, x_labels As Variant, y_labels As Variant, title As String)
    ...
    cht.Chart.SetSourceData Source:=WS.Range("AA4:AC5")
    ...
    cht.Chart.FullSeriesCollection(2).Name = "=Report!$AA$6"
    cht.Chart.FullSeriesCollection(2).Values = "=Report!$AB$6:$AC$6"
    cht.Chart.SeriesCollection.NewSeries
    cht.Chart.FullSeriesCollection(3).Name = "=Report!$AA$7"
    cht.Chart.FullSeriesCollection(3).Values = "=Report!$AB$7:$AC$7"
    cht.Chart.SeriesCollection.NewSeries
    cht.Chart.FullSeriesCollection(4).Name = "=Report!$AA$8"
    cht.Chart.FullSeriesCollection(4).Values = "=Report!$AB$8:$AC$8"
    ...
    cht.Chart.Axes(xlValue).MaximumScale = Application.Max(WS.Range("AB8:AC8")) * 1.2
